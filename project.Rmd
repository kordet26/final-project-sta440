...
conventional wisdom suggests that the president's party struggles in midterms, how would these developments, along with the Supreme Court's overturning of Roe, change the political calculus?
...
a "D" or "R" next to their name. However, in every election cycle, there are a handful of candidates who manage to defy the political gravity: a Democrat in rural Alaska, a Republican in the New York metro. This analysis aims to evaluate not only traditional metrics of candidate quality, such as incumbency and fundraising, but also the element of election denialism:
how did these candidates perform at the ballot box?
...
more Republican than open seats. Similarly, districts with elected Democratic incumbents were expected to vote 1.98 points more net Republican than open seats.

* For every one percentage point increase in the Democratic share of combined
fundraising, a district was expected to vote 0.099 points more net Democratic.

* For every one percentage point increase in the proportion of population with
college degrees, a district was expected to vote 0.107 points more net Democratic.
...
to vote 1.08 points more net Republican. (For reference, the most urban districts
...
vote 1.15 points more net Democratic than those without.
